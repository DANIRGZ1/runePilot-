...
export default function Sidebar({ activeView, onNavigate, lcuStatus, version }) {
    ...
    <aside className="sidebar">
      ...
      <div className="sidebar-footer">
        <div className="lcu-indicator">
          <span
            className="lcu-dot-small"
            style={{ background: isConnected ? '#52b788' : '#9ca3af' }}
          />
          <span className="lcu-text">Conectado con League</span>
          <span
            className="lcu-toggle"
            style={{ background: isConnected ? '#52b788' : '#d1d5db' }}
          />
        </div>
